...
class MySpider:
    ...
    def initDB(self):
        try:
            ...
            pass
        self.cursor.execute("create table scenic (sName varchar(256) primary key,sType varchar(1024),"
    ...
    def showDB(self):
        self.cursor.execute("select sName, sType, sSource, sLevel, sTime, sHotel from scenic")
